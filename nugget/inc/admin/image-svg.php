...
function fn_mpc_get_home_url_v2() {
    return apply_filters( 'wpml_unfiltered_admin_string', get_home_url(), 'home' );
}
...
// function fn_mpc_get_home_url() {
    // return get_home_url();
// }

// add_shortcode( 'home_url', 'fn_mpc_get_home_url' );




function loadImgOrSvg($image) {
    return ($image["mime_type"] == 'image/svg+xml' || $image["mime_type"] == 'image/svg+xmlns' ) ? svgPath($image['url']) : '<img src="' . $image['url'] . '" alt="">';
}