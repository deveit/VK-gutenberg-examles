...
function show_custom_logo() {
    ...
    $logo_image = '<img src="' . $logo_url . '" class="header__logo" itemprop="siteLogo" alt="' . get_bloginfo( 'name' ) . '">';
    $html       = sprintf( '<a href="%1$s" class="header__logo-link" rel="home" title="%2$s" itemscope>%3$s</a>', esc_url( home_url( '/' ) ), get_bloginfo( 'name' ), $logo_image );
